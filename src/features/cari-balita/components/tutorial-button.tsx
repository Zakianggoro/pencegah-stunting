      ...
      {isOpen ? (
        <div className="bg-white rounded-lg shadow-lg p-4 mb-4 w-64 border border-gray-200 animate-in fade-in slide-in-from-bottom-5">
          ...
          <p className="text-sm text-gray-600 mb-3">
            Halaman ini berguna untuk melihat riwayat pemeriksaan per balita. Gunakan nik untuk mencari nama bayi dan buka lebih lanjut untuk melihat detail pemeriksaan.
          </p>
        </div>
      ) : null}
