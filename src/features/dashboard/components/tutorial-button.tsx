      ...
      {isOpen ? (
        <div className="bg-white rounded-lg shadow-lg p-4 mb-4 w-64 border border-gray-200 animate-in fade-in slide-in-from-bottom-5">
          ...
          <p className="text-sm text-gray-600 mb-3">
            Lihat tutorial lengkap cara menggunakan aplikasi Pencegah Stunting.
          </p>
          <Link href="/tutorial" onClick={() => setIsOpen(false)}>
            <Button className="w-full">Buka Tutorial</Button>
          </Link>
        </div>
      ) : null}
